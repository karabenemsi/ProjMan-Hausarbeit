...
% Vorstellung in Hamburg (vor 15.Sept)
...
% Dauer, Methode, durchgängig, anzahl mitarbeiter


\section{Risikoplan}
\subsection{Annahmen} % Auswahl

% Änderungen an der Hardware (z.B. Starlink)
% Geräte sind defekt
% Geräte gehen verloren bei Verschiffung
% Wunsch Änderung Software
% Verzögerung durch Piraterie
